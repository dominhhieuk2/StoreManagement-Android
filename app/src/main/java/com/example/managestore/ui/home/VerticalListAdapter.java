...
public class VerticalListAdapter extends BaseAdapter {
    ...
    public VerticalListAdapter(Context ctx, List<Product> productList) {
        this.context = ctx;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        convertView = inflater.inflate(R.layout.product_horizontal, null);

        TextView name = convertView.findViewById(R.id.horizontalItemName);
        TextView category = convertView.findViewById(R.id.horizontalItemCategory);
        TextView price = convertView.findViewById(R.id.horizontalItemPrice);
        ImageView img = convertView.findViewById(R.id.horizontalItemImg);
